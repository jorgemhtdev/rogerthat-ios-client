...
- (UIImage *)_toolbarBackgroundImage{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake([UIScreen mainScreen].applicationFrame.size.width, 54), YES, 0.0);
...
- (void)viewWillLayoutSubviews{
    ...
    self.toolbar.frame = CGRectMake(0, CGRectGetHeight(self.view.frame) - 54, [UIScreen mainScreen].applicationFrame.size.width, 54);
}
