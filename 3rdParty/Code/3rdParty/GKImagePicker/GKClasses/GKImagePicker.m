...
@synthesize cropSize = cropSize_;
@synthesize delegate = delegate_;
@synthesize resizeableCropArea = resizeableCropArea_;
...
- (id)init{
    if (self = [super init]) {
        self.cropSize = CGSizeMake([UIScreen mainScreen].applicationFrame.size.width, [UIScreen mainScreen].applicationFrame.size.width);
