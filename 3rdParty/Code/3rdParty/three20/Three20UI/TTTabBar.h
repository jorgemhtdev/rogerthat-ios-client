...
@interface TTTabBar : TTView {
  ...
  id<TTTabDelegate> __weak _delegate;
}

@property (nonatomic, copy)     NSString*   tabStyle;

@property (nonatomic, weak)   TTTabItem*  selectedTabItem;
@property (nonatomic, weak)   TTTab*      selectedTabView;
@property (nonatomic)           NSInteger   selectedTabIndex;

@property (nonatomic, copy)     NSArray*    tabItems;
@property (nonatomic, readonly) NSArray*    tabViews;

@property (nonatomic, weak)   id<TTTabDelegate> delegate;
