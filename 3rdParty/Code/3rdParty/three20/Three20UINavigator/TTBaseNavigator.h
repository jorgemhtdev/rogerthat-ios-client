...
> {
  ...
  id<TTNavigatorDelegate>       __weak _delegate;
  id<TTNavigatorRootContainer>  __weak _rootContainer;
}
 ...
 * @default nil
 */
@property (nonatomic, weak) id<TTNavigatorRootContainer> rootContainer;
...
@property (nonatomic, weak) id<TTNavigatorDelegate> delegate;
