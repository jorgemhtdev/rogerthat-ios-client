...
@interface MCTActivityVC : MCTUIViewController <UITableViewDelegate, UITableViewDataSource, IMCTIntentReceiver>

@property int newActivities;
@property int oldActivities;
