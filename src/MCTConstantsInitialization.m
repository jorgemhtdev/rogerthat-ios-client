...
NSString *MCT_APP_PRIMARY_COLOR;
NSString *MCT_APP_SECONDARY_COLOR;
...
NSString *MCT_HOME_SCREEN_STYLE_NEWS = @"news";
...
void MCTInitializeConstants()
{
    ...
    MCT_APP_PRIMARY_COLOR = [configDict objectForKey:@"APP_PRIMARY_COLOR"];
    MCT_APP_SECONDARY_COLOR = [configDict objectForKey:@"APP_SECONDARY_COLOR"];
    ...
    } else if ([MCT_HOME_SCREEN_STYLE_NEWS isEqualToString:homeScreenStyle]) {
        MCT_HOME_SCREEN_STYLE = MCT_HOME_SCREEN_STYLE_NEWS;
    } else {
