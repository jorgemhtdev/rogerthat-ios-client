...
@interface MCTDateSelectView : UIControl <MCTWidget, UITableViewDelegate, UITableViewDataSource>
...
@property (nonatomic, strong) TTView *speechBubble;
@property (nonatomic, strong) UISegmentedControl *todayBtn;
