...
@interface MCTFacebookRegistration : NSObject <MCTFinishRegistrationCallback>

@property(nonatomic, weak) MCTUIViewController<UIAlertViewDelegate, UIActionSheetDelegate> *vc;
