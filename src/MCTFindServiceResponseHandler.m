...
@implementation MCTFindServiceResponseHandler


+ (MCTFindServiceResponseHandler *)responseHandlerWithSearchIdentifier:(NSString *)identifier
{
    MCTFindServiceResponseHandler *rh = [[MCTFindServiceResponseHandler alloc] init];
...
- (void)handleError:(NSString *)error
{
    ...
    MCTIntent *intent = [MCTIntent intentWithAction:kINTENT_SEARCH_SERVICE_FAILURE];
...
- (void)handleResult:(MCT_com_mobicage_to_service_FindServiceResponseTO *)result
{
    ...
    MCTIntent *intent = [MCTIntent intentWithAction:kINTENT_SEARCH_SERVICE_RESULT];
    [intent setString:self.identifier forKey:@"search_id"];
