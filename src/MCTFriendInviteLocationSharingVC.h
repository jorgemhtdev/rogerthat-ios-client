...
@interface MCTFriendInviteLocationSharingVC : MCTUIViewController <UIAlertViewDelegate, UITextViewDelegate>

@property (nonatomic, strong) MCTFriend *friend;
@property (nonatomic, strong) IBOutlet UILabel *inviteLabel;
@property (nonatomic, strong) IBOutlet PSPDFTextView *inviteText;
...
@property (nonatomic, strong) IBOutlet UIControl *sendButton;
