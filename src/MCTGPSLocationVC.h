...
@protocol MCTGPSLocationDelegate<NSObject>

@end

@interface MCTGPSLocationVC : MCTUIViewController <MKMapViewDelegate>

@property (nonatomic, strong) MCTFriendsPlugin *friendsPlugin;
@property (nonatomic, strong) IBOutlet MKMapView *mapView;
@property (nonatomic, strong) MCTFriendLocationAnnotation *annotation;
