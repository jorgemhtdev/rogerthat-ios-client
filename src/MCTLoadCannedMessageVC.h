...
@protocol MCTLoadCannedMessageDelegate <NSObject>
...
@interface MCTLoadCannedMessageVC : MCTUITableViewController

@property (nonatomic, weak) id<MCTLoadCannedMessageDelegate> delegate;
