...
#import "MCTWidget.h"
#import "3rdParty/GKImagePicker/GKClasses/GKImageCropViewController.h"


typedef enum {
    MCTPhotoUploadSourceCamera,
    MCTPhotoUploadSourcePhotoLibrary,
    MCTPhotoUploadSourceCameraOrPhotoLibrary
} MCTPhotoUploadSource;


@interface MCTPhotoUploadView : UIControl <MCTWidget, UINavigationControllerDelegate, UIImagePickerControllerDelegate,
GKImageCropControllerDelegate, UIActionSheetDelegate>

@property (nonatomic) CGFloat width;
@property (nonatomic, strong) NSDictionary *widgetDict;

@property (nonatomic) MCTPhotoUploadSource source;
@property (nonatomic) CGSize cropSize;
@property (nonatomic) NSInteger maxPhotoFileSize;

@property (nonatomic) NSInteger imageSize;
@property (nonatomic, strong) UIImage *image;
@property (nonatomic, strong) UIImageView *imageView;
@property (nonatomic, strong) TTButton *selectBtn;
