...
// REMARK: should have configurable topEndHighlightLocation property

@interface MCTReflectiveFillStyle : TTReflectiveFillStyle

@property (nonatomic) CGFloat topEndHighlightLocation;
