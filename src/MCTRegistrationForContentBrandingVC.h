...
@interface MCTRegistrationForContentBrandingVC : MCTUIViewController <ZXingDelegate, UIAlertViewDelegate, MCTFinishRegistrationCallback>
...
@property (nonatomic, retain) MCTHTTPRequest *httpRequest;
